...
export type Page = 'rating' | 'tournaments' | 'admin' | 'my-tournaments' | 'profile' | 'cities' | 'formats' | 'create-tournament' | 'tournamentEdit' | { page: 'tournament-view'; tournamentId: string };
