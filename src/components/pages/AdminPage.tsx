...
const UserCreationForm: React.FC<{ appState: AppState; addUser: (user: User) => void; addPlayer: (player: Player) => void }> = ({ appState, addUser, addPlayer }) => {
...
export const AdminPage: React.FC<AdminPageProps> = ({ appState, toggleUserStatus, deleteUser, addUser, addPlayer }) => (
